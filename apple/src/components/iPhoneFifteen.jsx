...
import image2 from '../media/fifteen.jpeg'

function IphoneFifteen() {
    return(
    <div className="card text-center text-bg-light justify-content-center ">
    <img src={image2} height='100%' width='auto'  className="card-img w-auto " alt="..." />
